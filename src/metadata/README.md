 ...
 * [parco-ca.yml](parco-ca.yml)
     * Determines how your purl.obolibrary.org/obo/parco-ca/ redirects will be handled
     ...
     * Paste in the contents of [parco-ca.yml](parco-ca.yml)
 ...
 * [parco-ca.md](parco-ca.md)
     ...
     * Paste in the contents of [parco-ca.md](parco-ca.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
